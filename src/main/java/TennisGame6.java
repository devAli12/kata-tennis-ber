public class TennisGame6 implements TennisGame {
    ...
    public String getScore()
    {
        ...
        {
            // tie score
            result = getScoreWhenPlayersHaveSamePoints();
        }
        ...
        else
        {
            ...
            String score1 =  getScore(player1Score);

            var score2 =  getScore(player2Score);
    ...
    private String getScoreWhenPlayersHaveSamePoints(){
        String tieScore;
        switch (player1Score)
        {
            case 0:
    ...
    private String getScore(int pointsScore){
       String score= switch (pointsScore)
        {
            case 0 ->  "Love";
            case 1 ->  "Fifteen";
            case 2 -> "Thirty";
